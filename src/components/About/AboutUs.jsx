...
const AboutUs = () => {
  ...
  useEffect(() => {
    fetch(`${env.VITE_CMS_BASE_URL}${env.VITE_PAGE__URL}about-the-fund`)
      .then((response) => {
  ...
  return (
    <Container
      fluid
      className="about-us px-0 mt-5 d-md-flex"
      id="about-the-found"
    >
      {fund && (
        <>
          ...
          <div className="content">
            ...
            <div className="content_videos mt-4 d-flex flex-column flex-lg-row">
              <a
                href="https://hivefa.wistia.com/medias/2qbwqtf33n"
                target="_blank"
              ...
              <a
                href="https://hivefa.wistia.com/medias/wyucowpn3q"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img src={video2} alt="" />
