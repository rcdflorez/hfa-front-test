        ...
        <div className="card-team_data card-team_data1">
          <div className="description p-0">
            ...
            <div dangerouslySetInnerHTML={
                {__html: descriptionPlus.founder}}>
            </div>

            <div dangerouslySetInnerHTML={
                {__html: descriptionPlus.chairman}}>
            </div>

            <div dangerouslySetInnerHTML={
                {__html: descriptionPlus.former}}>
            </div>

            <div dangerouslySetInnerHTML={
                {__html: descriptionPlus.libreum}}>
            </div>

            <div dangerouslySetInnerHTML={
                {__html: descriptionPlus.education}}>
            </div>

            <div dangerouslySetInnerHTML={
                {__html: descriptionPlus.family}}>
            </div>
